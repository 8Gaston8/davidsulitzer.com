...
- If the user explicitly asks to modify an image (e.g., "edit/retouch/inpaint/mask/translate/localize/change only X") -> **edit** (providing an input image alone does not imply edit; it may be a style reference)
